...
(function () {
  Tuner.DataBuffer = function () {
    ...
    buffer = function () {
      _results = [];
      for (var _i = 0, _ref = Tuner.Constants.FFTSIZE; 0 <= _ref ? _i < _ref : _i > _ref; 0 <= _ref ? _i++ : _i--) {
        _results.push(_i);
      }
      return _results;
...
(function () {
  ...
  Tuner.Display = function () {
    ...
    update = function () {
      ...
      updateHTML = function updateHTML(buffer, pitch, cents) {
      ...
      timeMax = 0;
      updateCanvas = function updateCanvas(buffer) {
      ...
      return update = function update(buffer, pitch, cents) {
    ...
    FFT = function () {
      function FFT(bufferSize, sampleRate) {
        ...
        while (limit < bufferSize) {
          (function () {
            _results = [];
            for (var _i = 0; 0 <= limit ? _i < limit : _i > limit; 0 <= limit ? _i++ : _i--) {
              _results.push(_i);
            }
            return _results;
        ...
        (function () {
          _results1 = [];
          for (var _j = 0; 0 <= bufferSize ? _j < bufferSize : _j > bufferSize; 0 <= bufferSize ? _j++ : _j--) {
            _results1.push(_j);
          }
          return _results1;
        }).apply(this).forEach(function (i) {
      ...
      FFT.prototype.transform = function (buffer) {
        ...
        (function () {
          _results = [];
          for (var _i = 0; 0 <= bufferSize ? _i < bufferSize : _i > bufferSize; 0 <= bufferSize ? _i++ : _i--) {
            _results.push(_i);
          }
          return _results;
        }).apply(this).forEach(function (i) {
        ...
        while (halfSize < bufferSize) {
          ...
          (function () {
            _results1 = [];
            for (var _j = 0; 0 <= halfSize ? _j < halfSize : _j > halfSize; 0 <= halfSize ? _j++ : _j--) {
              _results1.push(_j);
            }
            return _results1;
      ...
      FFT.prototype.calculateSpectrum = function () {
        ...
        return function () {
          _results = [];
          for (var _i = 0, _ref = this.bufferSize / 2; 0 <= _ref ? _i < _ref : _i > _ref; 0 <= _ref ? _i++ : _i--) {
            _results.push(_i);
          }
          return _results;
...
(function () {
  ...
  Tuner.frequencyUtils = function () {
    ...
    getPitch = function getPitch(freq, minDiff) {
...
(function () {
  Tuner.Gauss = function () {
    var gauss, process;
    gauss = function gauss(length, i, α, pow, E) {
      if (α == null) {
        α = 0.5;
      }
      if (pow == null) {
    ...
    process = function process(input, α) {
...
(function () {
  Tuner.Input = function () {
    ...
    success = function success(dataStream) {
...
(function () {
  Tuner.NoiseRemoval = function () {
    ...
    processCount = 0;
    limit = -Infinity;
    process = function process(spectrum) {
      if (processCount < 10) {
